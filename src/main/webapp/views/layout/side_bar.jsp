<section id="sidebar" class="dark-bg p-0 m-0 position-relative">
			...
			<ul id="sidebar-list" class="list-group  gap-2 w-100">
				...
				<li id="sidebar-item" class="list-item p-2 px-3 m-0 text"><a
					href="/hexa/users"><i class="fa-solid fa-users"></i><span class="mx-2">Users</span></a></li>
				<li id="sidebar-item" class="list-item p-2 px-3 m-0"><a href="/hexa/news_manage"><i
				...
				<li id="sidebar-item" class="list-item p-2 px-3 m-0"><a href="/hexa/news_create"><i
			...
			<ul id="sidebar-list" class="list-group  gap-2 w-100">
				...
				<li id="sidebar-item" class="list-item p-2 px-3 m-0"><a href=""><i
						class="fa-solid fa-globe"></i><span class="mx-2">Public
							Panel</span></a></li>
				<!-- for logout -->
